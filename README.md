...
it is mechanism to reuse stateful logic (for instance setting up a subscription and remembering the current value) all state and effects inside are fully isolated
